...
function SearchPopup() {
    ...
    return (
        <div className='flex justify-center'>
            {isOpen ? (
                <div className='w-4/5 mx-auto bg-white absolute top-[15%] border min-h-[350px] z-99999 p-5 rounded-xl'>
                        ...
                        <div className='w-5/6 mx-auto pt-5 h-full'>
                            {search.length === 0 ? (
                                <div className='flex justify-between items-start mt-5 border-t h-full'>
                                    <div className='flex-1 pt-6 ps-6 border-s border-b min-h-[350px]'>
                                        <div>
                                    ...
                                    <div className='px-6 border-x pt-6 border-b min-h-[350px]'>
                                ...
                                <>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex w-full max-w-sm flex-col gap-2 text-sm py-5">
                                            ...
                                            {suggestProducts.length === 0 ? (
                                                ...
                                                suggestProducts.slice(0, 5).map((item) => (
                                                    ...
                                                    <Link href={`/products/${item.handle}`}
                                                        className="flex items-center gap-4 cursor-pointer hover:bg-gray-50 rounded-lg p-2"
                                                        key={item.id}
                                                        onClick={() => {
                                                            dispatch(serchBoxPopup());
                                                            setSearch("");
                                                    ...
                                                    >
                                                        {item.image ? (
                                                            ...
                                                            <div className="w-14 h-14 bg-gray-100 rounded-md border flex items-center justify-center text-xs text-gray-400">
                                                                No Image
                                                            </div>
                                                        )}
